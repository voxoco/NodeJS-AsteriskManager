...
function ManagerReconnect(context) {
    ...
    if(context.backoff < 10000){ //The maximum reconection time is 10 seconds
      context.backoff += 1000; //Increase reconnection time by 1 second
    }
}
